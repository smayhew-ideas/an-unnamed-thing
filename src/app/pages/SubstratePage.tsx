      ...
      <div className="max-w-[1440px] mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-20">
        <div className="flex flex-col lg:flex-row gap-12 lg:gap-20">
          ...
          <div className="flex-1">
            ...
            <h1 className="text-[48px] md:text-[78px] font-thin mb-8">THE SUBSTRATE</h1>

            <div className="prose prose-invert max-w-none">
              <p className="text-[#adadad] text-[18px] md:text-[24px] leading-relaxed mb-6">
                An explainer of the necessity for Identity to recognize and assign a proportionate CAPEX
              </p>
